...
@section('content')
    ...
    <div class="col-md-8">
        <table class="table" border="1.5">
            <thead style="background-color: rgb(255, 254, 254); color: white">
                <tr>
            ...
            <tbody>
                @foreach ($champions as $champion)
                    <tr style="text-align: center">
                        ...
                        <td><a href="{{ route('champions.show', ['champion' => $champion->id]) }}"><i
                                    class="fa-solid fa-house" style="font-size: 2.5rem ; color: rgb(3, 157, 3)"></i></a>
                        </td>
                        <td><a href="{{ route('champions.edit', ['champion' => $champion->id]) }}"><i
