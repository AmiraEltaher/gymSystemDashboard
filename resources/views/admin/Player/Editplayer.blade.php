            ...
            <div class="col-md-6">
                ...
                <div class="form-group ">
                    ...
                    <input type="text" name="namePlayer" class="form-control" spellcheck="false" id=""
                        style="text-align: center" value="{{ $player->namePlayer }}">
                    @error('namePlayer')
                        {{ $message }}
                    @enderror
                </div>
    ...
    <div class="col-md-8" style="margin-top: 100px">
        ...
        <form method="POST" action="{{ route('players.update', ['player' => $player->id]) }}"
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="exampleInputPassword1">اضافه السن</label>
                    <input type="number" name="agePlayer" class="form-control" id=""
                        style="text-align: center" value="{{ $player->agePlayer }}">
                    @error('agePlayer')
                        {{ $message }}
                    @enderror
                </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="exampleInputEmail1">اضافه العنوان</label>
                    <input type="text" name="addresPlayer" class="form-control" id=""
                        style="text-align: center" value="{{ $player->addresPlayer }}">
                    @error('addresPlayer')
                        {{ $message }}
                    @enderror
                </div>
                ...
                <div class="form-group">
                    <label for="exampleInputPassword1">اضافه رقم الهاتف</label>
                    <input type="text" name="phonePlayer" class="form-control" id=""
                        style="text-align: center" value="{{ $player->phonePlayer }}">
                    @error('phonePlayer')
                        {{ $message }}
                    @enderror
                </div>
