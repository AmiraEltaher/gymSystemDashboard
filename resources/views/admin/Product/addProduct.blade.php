        ...
        <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
                <div class="form-group ">
                    ...
                    <input type="file" name="productImage" class="form-control" spellcheck="false" id=""
                ...
                <div class="form-group ">
                    ...
                    <input type="text" name="productName" class="form-control" spellcheck="false" id=""
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="productCost" class="form-control" id="" style="text-align: center"
                        value="{{ old('agePlayer') }}">
                    @error('productCost')
                        {{ $message }}
                    @enderror
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="productDiscount" class="form-control" id=""
                        style="text-align: center" value="{{ old('agePlayer') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="productDescription" class="form-control" id=""
                        style="text-align: center" value="{{ old('phonePlayer') }}">
                    @error('phonePlayer')
                        {{ $message }}
                    @enderror
                </div>
        ...
        <div class="col-md-8" style="margin-top: 100px">
            ...
            <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="exampleInputPassword1">اضافه السعر</label>
                        <input type="text" name="productCost" class="form-control" id=""
                            style="text-align: center" value="{{ old('agePlayer') }}">
                        @error('productCost')
                            {{ $message }}
                        @enderror
                ...
                <div class="col-md-12">
                    <button type="submit" name="add-player" class="btn btn-primary form-control"
                        style="margin: auto">اضافه منتج
                        جديد</button>
                </div>
            </form>
