            ...
            <div class="col-md-6">
                ...
                <div class="form-group ">
                    ...
                    <input type="text" name="productName" class="form-control" spellcheck="false" id=""
                        style="text-align: center" value="{{ $product->productName }}">
                    @error('productName')
                        {{ $message }}
                    @enderror
                </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="productDiscount" class="form-control" id=""
                        style="text-align: center" value="{{ $product->productDiscount }}">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="productCost" class="form-control" id=""
                            style="text-align: center" value="{{ $product->productCost }}">
                        @error('productCost')
                            {{ $message }}
                        @enderror
                    </div>
