    ...
    <table class="table" border="1.5">
        ...
        <tbody>
            ...
            <tr style="text-align: center">
                ...
                <td>{{  $offer->offerEnd}}</td>
                <td>{{  $offer->offerFeatures}}</td>
                <td><a href="{{route('offers.show', ['offer' => $offer->id])}}"><i class="fa-solid fa-house" style="font-size: 2.5rem ; color: rgb(3, 157, 3)"></i></a></td>
                <td><a href="{{route('offers.edit', ['offer' => $offer->id])}}"><i class="fa-solid fa-pen-to-square" style="font-size: 2.5rem;color: blue"></i></a></td>
